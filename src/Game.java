...
public class Game extends Canvas implements Runnable {
	...
	//loading the level goes here. And the actual loading happens in LevelLoader.java
	...
	//Called from MouseInput.java. Sets everything so, that we can restart our game.
